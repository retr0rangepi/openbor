...
HRESULT openbor_changedrawmethod(ScriptVariant **varlist , ScriptVariant **pretvar, int paramCount)
{
    ...
    *pretvar = NULL;
    ...
    case _dm_flipx:
        ...
        pmethod->flipping.axis.x = (int)temp;
        break;
    case _dm_flipy:
        if(FAILED(ScriptVariant_IntegerValue(varlist[2], &temp)))
        {
        ...
        pmethod->flipping.axis.y = (int)temp;
        break;
    ...
    */
    ...
    switch(varlist[1]->lVal)
    {
        ...
        case _dm_flipx:
            ...
            break;
        case _dm_flipy:
            (*pretvar)->lVal = (int)pmethod->flipping.axis.y;
            break;
        case _dm_perspective:
...
HRESULT openbor_setdrawmethod(ScriptVariant **varlist , ScriptVariant **pretvar, int paramCount)
{
    ...
    *pretvar = NULL;
    ...
    pmethod->flipping.axis.x = (int)value[3];
    pmethod->flipping.axis.y = (int)value[4];
